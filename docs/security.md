...
symlink escapes, and assert secret values never reach output. `npx` package retrieval occurs before
Noxroot and is not part of the runtime preview guarantee.
